...
export default class CashScriptLexer extends Lexer {
    ...
    static readonly VersionLiteral = 59;
    static readonly BooleanLiteral = 60;
    static readonly NumberUnit = 61;
    static readonly NumberLiteral = 62;
    static readonly NumberPart = 63;
    static readonly ExponentPart = 64;
    static readonly Bytes = 65;
    static readonly Bound = 66;
    static readonly StringLiteral = 67;
    static readonly DateLiteral = 68;
    static readonly HexLiteral = 69;
    static readonly TxVar = 70;
    static readonly NullaryOp = 71;
    static readonly Identifier = 72;
    static readonly WHITESPACE = 73;
